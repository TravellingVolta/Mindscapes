...
{
    public class GDEFlashCardsData : IGDEData
    {
        ...
        public GDEFlashCardsData(string key) : base(key)
        {
        ...
        public override Dictionary<string, object> SaveToDict()
		{
			...
			dict.Add(GDMConstants.SchemaKey, "FlashCards");
        ...
        public GDEFlashCardsData ShallowClone()
		{
			string newKey = Guid.NewGuid().ToString();
			GDEFlashCardsData newClone = new GDEFlashCardsData(newKey);
        ...
        public GDEFlashCardsData DeepClone()
		{
			GDEFlashCardsData newClone = ShallowClone();
            return newClone;
		}
